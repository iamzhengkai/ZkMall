...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private boolean canLoop = BannerConfig.CAN_LOOP;
    ...
    private void setBannerStyleUI() {
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.SPLASH_CIRCLE_INDICATOR: //added by zk
                ...
                indicatorHolder.setLayoutParams(layoutParams);
                mIndicatorSelectedResId = R.drawable.big_gray_radius;
                mIndicatorUnselectedResId = R.drawable.big_white_radius;
    ...
    private void initImages() {
        ...
        if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
                bannerStyle == BannerConfig.SPLASH_CIRCLE_INDICATOR ||
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (bannerStyle == BannerConfig.SPLASH_CIRCLE_INDICATOR){
                ...
                params.rightMargin = DensityUtil.dp2px(getContext(),BannerConfig.SPLASH_PADDING_SIZE);
            }
            if (i == 0) {
