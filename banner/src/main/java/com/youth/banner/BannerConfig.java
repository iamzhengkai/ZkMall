...
public class BannerConfig {
    ...
    public static final int SPLASH_CIRCLE_INDICATOR = 6;
    /**
     * indicator gravity
     */
    ...
    public static final int SPLASH_BOTTOM_MARGIN = 20;
    public static final int SPLASH_PADDING_SIZE = 5;
    public static final int TIME = 2000;
    public static final int DURATION = 800;
    public static final boolean IS_AUTO_PLAY = true;
    public static final boolean IS_SCROLL = true;
    public static final boolean CAN_LOOP = true;
